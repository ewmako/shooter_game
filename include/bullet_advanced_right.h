#ifndef BULLET_ADVANCED_RIGHT_H
#define BULLET_ADVANCED_RIGHT_H
 ...
 */
class BulletAdvancedRight : public Bullet
{
public:
    /**
     ...
     */
    BulletAdvancedRight(int position_y_, int position_x_, Owner owner_);

    /**
     * @brief move              Sprawdza czy możliwy jest ruch pocisku w osi y,
